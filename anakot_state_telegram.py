"""Telegram DM topic-mode mixin for :class:`anakot_state.SessionDB`."""
...
from anakot_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
from anakot_state_errors import StateDbReplacedError
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one Anakot session. A session may be linked to
