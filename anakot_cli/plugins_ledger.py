...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`anakot_cli.plugins.PluginManager`.
"""
...
from anakot_cli.plugins_loader import _plugin_home_scope
from anakot_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from anakot_cli.plugins import _PLUGINS_DEBUG
