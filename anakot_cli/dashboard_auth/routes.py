...
from anakot_cli.dashboard_auth import prefix as _prefix_mod
...
from anakot_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from anakot_cli.dashboard_auth.login_page import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("anakot_session_pkce", "")
