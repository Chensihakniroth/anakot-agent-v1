...
from anakot_cli.dashboard_auth import list_session_providers
from anakot_cli.dashboard_auth.audit import AuditEvent, audit_log
from anakot_cli.dashboard_auth.base import ProviderError
...
from anakot_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from anakot_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from anakot_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["anakot.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('anakot_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
