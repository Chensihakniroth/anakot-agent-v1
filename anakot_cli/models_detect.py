...
Split out of ``anakot_cli.models``. The detection ladder there consults static catalogs, then the
...
def current_provider_catalog_match(model_name: str, current_provider: str) -> Optional[str]:
    ...
    Goes through :func:`anakot_cli.models.cached_provider_model_ids` (1h TTL, stale-while-
    ...
    from anakot_cli.models import cached_provider_model_ids, normalize_provider
...
def current_provider_owns_vendor(model_name: str, current_provider: str) -> bool:
    ...
    from anakot_cli.model_normalize import detect_vendor
    from anakot_cli.models import _AGGREGATOR_PROVIDERS, _PROVIDER_MODELS, normalize_provider
