"""Relay subscriber for the persisted Anakot shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Anakot counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Anakot shared metric: %s", metric_name, exc_info=True
                )
