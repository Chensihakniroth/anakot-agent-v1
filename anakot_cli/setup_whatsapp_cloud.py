...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Anakot to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Anakot needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Anakot gateway in another terminal:",
        "         anakot gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://anakot-agent.nousresearch.com/docs/user-guide/",
