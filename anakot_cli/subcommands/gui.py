...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Anakot Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any anakot CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--anakot-root",
        help="Override the Anakot source root used by Desktop (sets ANAKOT_DESKTOP_ANAKOT_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ANAKOT_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Anakot Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Anakot Local Signing)",
    )
