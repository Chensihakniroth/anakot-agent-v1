"""``anakot sync`` subcommand parser — Skill Sync.
...
def build_sync_parser(subparsers, *, cmd_sync: Callable) -> None:
    ...
    sync_parser = subparsers.add_parser(
        ...
        epilog="Examples:\n"
            "  anakot sync status            what is synced, and from where\n"
            "  anakot sync enable my-skill   include a skill in your sync\n"
            "  anakot sync now               pull, then push\n"
            "  anakot sync propose my-skill  share a skill with your team\n",
