...
``anakot --tui`` child cannot be spawned. The exception text alone is either
...
CHAT_NEEDS_NODE = (
    "Chat could not start: Anakot needs Node.js to run the terminal chat. "
...
CHAT_START_FAILED = "Chat could not start: {detail} Check the server log (`anakot dashboard` terminal) and click Start new session."
