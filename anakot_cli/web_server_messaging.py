...
from anakot_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Anakot from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Anakot to Discord DMs, channels, and threads.",
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Anakot from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Anakot to Mattermost channels and direct messages.",
        "docs_url": "https://mattermost.com/deploy/",
        "env_vars": ("MATTERMOST_URL", "MATTERMOST_TOKEN", "MATTERMOST_ALLOWED_USERS"),
        "required_env": ("MATTERMOST_URL", "MATTERMOST_TOKEN"),
    },
    "matrix": {
        "name": "Matrix", "description": "Use Anakot in Matrix rooms and direct messages.",
    ...
    "whatsapp": {
        "name": "WhatsApp",
        "description": "Use Anakot through the bundled WhatsApp bridge with QR-based auth.",
    ...
    "homeassistant": {
        "name": "Home Assistant",
        "description": "Control your smart home from Anakot via Home Assistant.",
        "docs_url": "https://www.home-assistant.io/docs/authentication/",
        "env_vars": ("HASS_URL", "HASS_TOKEN"), "required_env": ("HASS_URL", "HASS_TOKEN"),
    },
    "email": {
        "name": "Email", "description": "Talk to Anakot through an IMAP/SMTP mailbox.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Anakot to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Anakot inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Anakot to Google Chat via Cloud Pub/Sub.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/weixin/",
        "env_vars": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN", "WEIXIN_BASE_URL"),
        "required_env": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN"),
    },
    "bluebubbles": {
        "name": "BlueBubbles (iMessage)",
        "description": "Use Anakot through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Anakot to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        "description": "Connect Anakot to Microsoft Teams chats via the Bot Framework.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        "description": "Relay messages between an IRC channel (or DMs) and Anakot.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Anakot from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Anakot over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Anakot through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Anakot over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Anakot to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
    ...
    "webhook": {
        ...
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Anakot via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://anakot-agent.nousresearch.com/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
        "name": "Relay (experimental)",
        "description": "Generic relay adapter fronted by the Anakot Relay connector.",
...
def _platform_env_prefixes(platform_id: str) -> tuple[str, ...]:
    ...
    from anakot_cli.profile_channels import platform_env_prefixes
...
def _whatsapp_session_path() -> Path:
    from anakot_constants import get_anakot_dir
    return get_anakot_dir("platforms/whatsapp/session", "whatsapp/session")
...
def _restart_gateway_after_whatsapp_onboarding(profile: Optional[str] = None) -> dict[str, Any]:
    from anakot_cli.web_server_gateway import _restart_gateway_after
    return _restart_gateway_after(profile, what="WhatsApp onboarding", label="WhatsApp onboarding")


_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.anakot-agent.nousresearch.com"
_TELEGRAM_ONBOARDING_USER_AGENT = f"AnakotDashboard/{__version__}"
