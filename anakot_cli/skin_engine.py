"""Anakot skin/theme engine — the theme SDK for every surface."""
...
# Branding shared by every Anakot-named built-in (mono/daylight override help_header).
_ANAKOT_BRANDING: Dict[str, str] = _branding(
    "Anakot", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ANAKOT_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ANAKOT_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_anakot_home_override() is None else anakot_home_key()
