...
One Anakot process may serve many profiles (multiplex gateway, Desktop/dashboard ``serve``), and
...
exits 0, because most patterns have legitimate sites (a standalone ``anakot -p x`` process where
