...
def main() -> None:
    ...
    anakot_home = Path(tempfile.mkdtemp(prefix="anakot-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "anakot-gateway-smoke",
    ...
    print(json.dumps({"anakot_home": str(anakot_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
