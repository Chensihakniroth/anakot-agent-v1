...
_BASELINE = frozenset(
    {
        "tests/anakot_cli/test_doctor.py",
        "tests/anakot_cli/test_gateway.py",
        "tests/anakot_cli/test_gateway_proc_fallback.py",
        "tests/anakot_cli/test_linux_sandbox_fixup.py",
