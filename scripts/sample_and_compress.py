...
DEFAULT_DATASETS = [
    ...
    "Chensihakniroth/anakot-agent-v1-megascience-sft1",
    "NousResearch/Anakot-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Anakot-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-anakot-agent"
]
