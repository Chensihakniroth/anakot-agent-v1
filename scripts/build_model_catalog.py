#!/usr/bin/env python3
"""Build the Anakot Model Catalog — a centralized JSON manifest of curated models.
...
Anakot CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Anakot release.
...
# Ensure ANAKOT_HOME is set for imports that touch it at module level.
os.environ.setdefault("ANAKOT_HOME", os.path.join(os.path.expanduser("~"), ".anakot"))

from anakot_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "https://anakot-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Anakot '
