#!/usr/bin/env python3
"""Build the Anakot Skills Index — a centralized JSON catalog of all skills.
...
`anakot skills search/install` can use it without hitting the GitHub API.
...
# Ensure ANAKOT_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Anakot Skills Index...", flush=True)
