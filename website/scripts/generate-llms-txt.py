#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Anakot docs site.
...
Both publish at:
  https://anakot-agent.nousresearch.com/docs/llms.txt
  https://anakot-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://anakot-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Anakot as a Python Library", None),
        ("guides/use-mcp-with-anakot", "Use MCP with Anakot", None),
        ("guides/use-voice-mode-with-anakot", "Use Voice Mode with Anakot", None),
        ("guides/use-soul-with-anakot", "Use SOUL.md with Anakot", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Anakot"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/Chensihakniroth/anakot-agent-v1")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Anakot Agent — Full Documentation\n",
        (
            "This file is the entire Anakot Agent documentation concatenated for LLM "
        ...
        "Canonical site: https://anakot-agent.nousresearch.com/docs\n",
        "Short index: https://anakot-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
