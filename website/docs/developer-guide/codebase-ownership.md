...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `anakot_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `anakot_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Anakot Plugin](plugins/index.md) |
...
| Session storage | `anakot_state.py`, `anakot_state_*.py` | [Session Storage](session-storage.md) |
