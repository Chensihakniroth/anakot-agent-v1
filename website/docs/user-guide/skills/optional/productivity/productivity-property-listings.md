...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Anakot desktop transcript.
...
- A Anakot desktop conversation for native cards; the backend may be local or remote.
...
```text
anakot skills install official/productivity/property-listings
```
