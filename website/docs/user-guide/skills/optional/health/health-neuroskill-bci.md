...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/health/neuroskill-bci` |
...
Connect Anakot to a running [NeuroSkill](https://neuroskill.com/) instance to read
