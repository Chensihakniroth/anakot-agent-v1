...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/research/gitnexus-explorer` |
...
| Related skills | [`anakot-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-anakot-agent.md), [`codebase-inspection`](../../bundled/software-development/software-development-codebase-inspection.md) |
