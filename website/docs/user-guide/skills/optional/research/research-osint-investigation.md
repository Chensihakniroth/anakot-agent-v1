...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Anakot Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ANAKOT_OSINT_CACHE/icij/ (default: ~/.cache/anakot-osint/icij/).
...
# Set ANAKOT_OSINT_UA=your-app/1.0 (your@email) to identify yourself
