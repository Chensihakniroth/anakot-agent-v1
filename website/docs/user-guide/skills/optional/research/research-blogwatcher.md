...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/research/blogwatcher` |
...
## Working with Anakot tools (read this first)

`blogwatcher-cli` is the feed database; Anakot tools do the automation around it:
