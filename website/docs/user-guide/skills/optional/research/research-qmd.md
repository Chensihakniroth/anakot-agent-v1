...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/research/qmd` |
...
| Related skills | [`obsidian`](../../bundled/note-taking/note-taking-obsidian.md), [`anakot-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-anakot-agent.md), [`arxiv`](../../bundled/research/research-arxiv.md) |
...
Anakot Agent via the native MCP client. This is the preferred
...
Then configure Anakot Agent to connect via HTTP:
