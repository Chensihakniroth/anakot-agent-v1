...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing anakot tool access (web_search, file ops). Stateless. |
