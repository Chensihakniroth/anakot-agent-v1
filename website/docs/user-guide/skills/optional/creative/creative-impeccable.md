...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/creative/impeccable` |
...
> ships and verifies a Anakot-native skill bundle under `.anakot/skills/`.
> `anakot skills install impeccable` pulls the current bundle live from that
