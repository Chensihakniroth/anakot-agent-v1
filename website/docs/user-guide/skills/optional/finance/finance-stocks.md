...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Anakot Agent |
| License | MIT |
...
```
SCRIPT=~/.anakot/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.anakot/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
