...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/web-development/page-agent` |
...
- User wants **Anakot itself to drive a browser** → use Anakot' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
