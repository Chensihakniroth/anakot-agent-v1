...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/autonomous-ai-agents/blackbox` |
...
| Related skills | [`claude-code`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code.md), [`codex`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-codex.md), [`anakot-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-anakot-agent.md) |
...
Delegate coding tasks to [Blackbox AI](https://www.blackbox.ai/) via the Anakot terminal. Blackbox is a multi-model coding agent CLI that dispatches tasks to multiple LLMs (Claude, Codex, Gemini, Blackbox Pro) and uses a judge to select the best implementation.
