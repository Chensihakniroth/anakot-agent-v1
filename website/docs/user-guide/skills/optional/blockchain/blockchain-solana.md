...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Anakot Agent |
| License | MIT |
...
Helper script path: ~/.anakot/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.anakot/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
