...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Anakot Agent |
| License | MIT |
...
The script reads `${ANAKOT_HOME:-~/.anakot}/.env` for two optional defaults:
...
Helper script: `~/.anakot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.anakot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ANAKOT_HOME:-~/.anakot}/.env`.
...
```bash
python ~/.anakot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.anakot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
