...
| | |
|---|---|
| Source | Optional — install with `anakot skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Anakot Agent |
| License | MIT |
...
| Related skills | [`solana`](./blockchain-solana.md) |
...
Helper script path: `~/.anakot/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.anakot/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.anakot/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.anakot/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
