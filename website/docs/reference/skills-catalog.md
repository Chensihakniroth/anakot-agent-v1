...
| [`anakot-agent`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-anakot-agent.md) | Use, configure, theme, extend, and orchestrate Anakot Agent. | `autonomous-ai-agents\anakot-agent` |
...
| [`anakot-agent-skill-authoring`](../user-guide/skills/bundled/software-development/software-development-anakot-agent-skill-authoring.md) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\anakot-agent-skill-authoring` |
| [`inspecting-anakot-desktop-dom`](../user-guide/skills/bundled/software-development/software-development-inspecting-anakot-desktop-dom.md) | Read the live Anakot desktop DOM/CSS over CDP. | `software-development\inspecting-anakot-desktop-dom` |
