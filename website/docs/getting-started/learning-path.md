...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Anakot Agent documentation based on your experience level and goals.'
---

# Learning Path

Anakot Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Anakot Agent yet, begin with the [Installation guide](./installation.md) and then run through the [Quickstart](./quickstart.md). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users almost always want `anakot setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](../integrations/nous-portal.md).
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Anakot Agent can do.
...
Use Anakot Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Anakot Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Anakot Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Anakot](../guides/use-voice-mode-with-anakot.md)
...
:::tip
Cron jobs let Anakot Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::
...
Extend Anakot Agent with your own tools and reusable skill packages.

1. [Plugins](../user-guide/features/plugins.md)
2. [Build a Anakot Plugin](../developer-guide/plugins/index.md)
...
page is for built-in Anakot core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Anakot Agent's RL training pipeline (powered by [Atropos](https://github.com/NousResearch/atropos)).
...
Integrate Anakot Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Anakot tools programmatically | [Code Execution](../user-guide/features/code-execution.md) |
