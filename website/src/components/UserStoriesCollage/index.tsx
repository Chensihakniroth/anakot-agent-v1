  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Anakot Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Anakot &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Anakot?{' '}
        <a
          href="https://github.com/Chensihakniroth/anakot-agent-v1/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
