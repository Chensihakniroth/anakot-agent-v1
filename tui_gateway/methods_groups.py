...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the Anakot gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("ANAKOT_PROFILE") or "default").strip() or "default"
