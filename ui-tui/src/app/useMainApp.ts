...
import { JSON_RPC_METHOD_NOT_FOUND, type ServerRequest } from '@anakot/shared/json-rpc-channel'
...
export function useMainApp(gw: GatewayClient) {
  ...
  // "Anakot stopped and could not be restarted" is said once per outage; reset on gateway.ready.
  ...
  const cwd = ui.info?.cwd || process.env.ANAKOT_CWD || process.cwd()
