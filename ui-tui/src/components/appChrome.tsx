import { Box, type ScrollBoxHandle, stringWidth, Text } from '@anakot/ink'
import { compactNumber } from '@anakot/shared/format'
import type { Usage } from '@anakot/shared/gateway-events'
...
export function StatusRule({
  ...
  // Dev-only readout (ANAKOT_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ANAKOT_DEV_CREDITS), lowest priority,
