 ...
 *
 * Symptom: in `anakot --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@anakot/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using anakot --tui and as i type multiline my caret at the end will often ' +
