 ...
 * across theme x background scenes to <tmpdir>/anakot-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@anakot/ink'
...
// The regenerated slate light_colors block from anakot_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/anakot-agent',
...
const setup = (bgHex: string) => {
  process.env.ANAKOT_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
