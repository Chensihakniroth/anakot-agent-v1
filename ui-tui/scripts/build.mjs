...
await build({
  ...
  // Skip the prebuilt @anakot/ink bundle and inline the source instead:
  ...
  alias: { '@anakot/ink': resolve(root, 'packages/anakot-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The anakot_cli launcher
