...
Standard library only, so it runs in any Anakot environment without an install
...
USER_AGENT = "anakot-agent/1.0 (rss-feeds skill; +https://github.com/Chensihakniroth/anakot-agent-v1)"
TIMEOUT = 20
NS = {
