...
DEFAULT_UA = (
    "anakot-osint-investigation/0.2 "
    "(+https://github.com/Chensihakniroth/anakot-agent-v1; "
    "set ANAKOT_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ANAKOT_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
