...
Data file: $ANAKOT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ANAKOT_HOME = Path(os.environ.get("ANAKOT_HOME", Path.home() / ".anakot"))
DATA_DIR = _ANAKOT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
