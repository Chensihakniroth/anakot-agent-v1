 ...
 *
 * Each entry is a key/value pair that lands in the packaged Anakot.app's
 ...
 * "Anakot wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Anakot wants to access Music" when Anakot never touches the Music
