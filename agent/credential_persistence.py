...
``anakot_cli.auth`` imports so the pool model and the auth-store write boundary
...
# Sources Anakot owns and may persist with secrets.  Any other non-empty,
