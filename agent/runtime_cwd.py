...
_SESSION_CWD: ContextVar = ContextVar("ANAKOT_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Anakot source tree, a
    legitimate workspace when developing Anakot; fallback-directory policy lives in the caller."""
