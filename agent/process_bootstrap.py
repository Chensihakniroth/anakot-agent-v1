...
from anakot_bootstrap import _happy_eyeballs_create_connection
...
ANAKOT_TRANSPORT_OWNER_EXT = "anakot_transport_owner"
...
def _shared_transport_cls():
    ...
    class _SharedTransportImpl(httpx.BaseTransport):
        ...
        def handle_request(self, request: Any) -> Any:
            ...
            request.extensions[ANAKOT_TRANSPORT_OWNER_EXT] = id(self)
