...
os.environ['ANAKOT_NIX_BUILD'] = '1'
sys.path.insert(0, str(root))
commands = importlib.import_module("anakot_cli.cli_commands_mixin")
GoalManager = importlib.import_module("anakot_cli.goals").GoalManager
