...
sandbox = tempfile.TemporaryDirectory(prefix="anakot-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    ANAKOT_HOME=sandbox.name + "/anakot",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    ANAKOT_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Anakot home is written.
