...
from anakot_cli import cli_commands_mixin, goals
...
server._anakot_home = Path(home.name)
...
with patch('anakot_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
