...
os.environ.setdefault("ANAKOT_HOME", os.path.expanduser("~/.anakot"))  # LIVE: real auxiliary judge calls (cents)
from anakot_cli import goals
goal = ("Simplify the anakot-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
