...
# Temp ANAKOT_HOME with the real auth + a config that shortens the generic sequential deadline to 40 s, so the
...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["ANAKOT_HOME"] = home
real_home = os.environ.get("ANAKOT_HOME_SOURCE", os.path.expanduser("~/.anakot"))  # credentials are copied from here into a temp home
