...
os.environ["ANAKOT_HOME"] = str(root / ".anakot")
from anakot_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".anakot" / "profiles" / name
    ...
    d = root / ".anakot/logs/update_receipts"
    ...
    home = root / ".anakot/profiles/beta"
