...
Run from a checkout with ANAKOT_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["ANAKOT_MAX_TOKENS"] = "13"
...
from anakot_cli.moa_config import _normalize_preset
