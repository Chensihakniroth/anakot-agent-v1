...
The run gets a throwaway ANAKOT_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE ANAKOT_HOME is redirected to the
