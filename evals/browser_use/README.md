...
The A/B battery behind PR [#81958](https://github.com/Chensihakniroth/anakot-agent-v1/pull/81958)
...
- **Arms differ only by tree + config.** `base` runs the built-in twelve
  ...
  digest's value). Each cell gets a throwaway `ANAKOT_HOME`; web-fetch
