...
Scratch HOME, ANAKOT_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && ANAKOT_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `anakot`; PATH contains a different inert `anakot` that exits 2
