...
os.environ["ANAKOT_HOME"] = tempfile.mkdtemp(prefix="anakot-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("anakot", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from anakot_cli import web_server  # noqa: E402
from anakot_cli.dashboard_auth import register_provider  # noqa: E402
from anakot_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.anakot_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "anakot_session_at=expired-at; anakot_session_rt=cookie-stale; anakot_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
