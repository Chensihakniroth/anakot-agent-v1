...
benchmarked ten harnesses on hostile-file handling — and whose Anakot column
...
Every task runs the full anakot agent (file + terminal + search toolsets)
...
Rules of engagement (from anakotbench discipline):
