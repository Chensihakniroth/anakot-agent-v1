...
LOCAL_STT_COMMAND_ENV = "ANAKOT_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "ANAKOT_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via anakot_cli.models.deepinfra_base_url (shared).
