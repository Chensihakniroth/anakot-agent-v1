...
DIALOG_BRIDGE_HOST = "anakot-dialog-bridge.invalid"
...
(() => {
  if (window.__anakotDialogBridgeInstalled) return;
  window.__anakotDialogBridgeInstalled = true;
  const ENDPOINT = "http://anakot-dialog-bridge.invalid/";
