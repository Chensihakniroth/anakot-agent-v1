...
Used by anakot_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "ANAKOT_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"ANAKOT_HOME": _anakot_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'ANAKOT_INDEX_TTL': ('tools.skills_hub_search', 'ANAKOT_INDEX_TTL'),
    'ANAKOT_INDEX_URL': ('tools.skills_hub_search', 'ANAKOT_INDEX_URL'),
    'AnakotIndexSource': ('tools.skills_hub_official', 'AnakotIndexSource'),
