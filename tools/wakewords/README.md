...
`hey_anakot.onnx` / `hey_anakot.tflite` — the on-device "Hey Anakot" hotword
...
- **Label:** the model registers as `hey_anakot` (matches the filename).
