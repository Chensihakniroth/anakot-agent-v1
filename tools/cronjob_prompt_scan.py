...
# containing `cat ~/.anakot/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `anakot-agent-dev` skill contains a security postmortem mentioning `cat ~/.anakot/.env`, which tripped
