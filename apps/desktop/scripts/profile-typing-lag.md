...
cd apps/desktop
XCURSOR_SIZE=24 ANAKOT_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/anakot-typing
# → /tmp/anakot-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/anakot-typing.before.heapsnapshot
# → /tmp/anakot-typing.after.heapsnapshot
```
