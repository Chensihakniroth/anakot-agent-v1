...
export function registerGitIpc({ resolveGitBinary, resolveGhBinary }: GitIpcDeps) {
  ...
  ipcMain.handle('anakot:git:worktreeList', async (_event, repoPath) => listWorktrees(repoPath, resolveGitBinary()))
  ...
  ipcMain.handle('anakot:git:branchList', async (_event, repoPath) => listBranches(repoPath, resolveGitBinary()))
  ...
  ipcMain.handle('anakot:git:repoStatus', async (_event, repoPath) => repoStatus(repoPath, resolveGitBinary()))
  ...
  ipcMain.handle('anakot:git:fileDiff', async (_event, repoPath, filePath) =>
  ...
  ipcMain.handle('anakot:git:review:commitContext', async (_event, repoPath) =>
    reviewCommitContext(repoPath, resolveGitBinary())
  )
  ipcMain.handle('anakot:git:review:push', async (_event, repoPath) => reviewPush(repoPath, resolveGitBinary()))
  ipcMain.handle('anakot:git:review:shipInfo', async (_event, repoPath) => reviewShipInfo(repoPath, resolveGhBinary()))
  ...
  ipcMain.handle('anakot:git:review:createPr', async (_event, repoPath) =>
