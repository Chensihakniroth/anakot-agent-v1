 ...
 *
 * A public install can end up with `origin=git@github.com:Chensihakniroth/anakot-agent-v1.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Chensihakniroth/anakot-agent-v1.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/anakot-agent'
