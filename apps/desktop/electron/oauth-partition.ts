 ...
 * (`persist:anakot-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `anakot_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:anakot-remote-oauth'
...
// `Partitions/anakot-remote-oauth%3Aconn%3A<id>` folder is left on disk,
