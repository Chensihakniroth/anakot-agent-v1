 ...
 * startAnakot() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startAnakot() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startAnakot`, re-emits
