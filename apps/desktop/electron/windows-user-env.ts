...
// even though a fresh shell — and the Anakot CLI — sees it immediately. The
// desktop's ANAKOT_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\anakot. Reading
...
//       ANAKOT_HOME    REG_SZ    F:\Anakot\data
//
