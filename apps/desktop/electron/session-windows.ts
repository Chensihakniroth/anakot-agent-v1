...
// by main.ts (`setBackgroundThrottling` driven by the merged `anakot:active-work`
...
// (the "Anakot idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Anakot" wake word has NO preceding click,
