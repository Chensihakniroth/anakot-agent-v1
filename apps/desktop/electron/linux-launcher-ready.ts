/**
 * Tells the `anakot desktop` launcher that the main window is on screen.
 *
 ...
 * hands us the write end of a pipe in `ANAKOT_DESKTOP_READY_FD`; one byte means
 * "mapped, safe to heal". A launch without the variable is a no-op.
 */

import fs from 'node:fs'

export const LAUNCHER_READY_FD_ENV = 'ANAKOT_DESKTOP_READY_FD'
