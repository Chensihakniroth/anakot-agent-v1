...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@anakot/plugin-sdk'
 ...
 *  (anakot-agent#90102) and are discarded. Without `canonical_session` (older
