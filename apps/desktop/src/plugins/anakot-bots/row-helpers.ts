...
import { atom, host, useValue } from '@anakot/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @anakot, never @default (#89484).
 ...
 *  (anakot-agent#90268). Older gateways omit worker_session — always false. */
