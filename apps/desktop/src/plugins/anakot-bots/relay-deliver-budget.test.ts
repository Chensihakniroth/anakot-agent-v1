...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/anakot-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'anakot_cli/config_defaults.py'), 'utf8')
