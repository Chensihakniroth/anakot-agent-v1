...
const STORAGE_KEY = 'anakot.desktop.layoutTree.v2'

writeKey('anakot.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('anakot.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('anakot.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'anakot.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'anakot.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'anakot.desktop.hiddenStripTabs.v1'
...
writeKey('anakot.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ANAKOT_LAYOUT_TREE__ = {
    close: closeTreePane,
