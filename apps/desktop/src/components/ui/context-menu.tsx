...
export const ANAKOT_CONTEXT_MENU_TRIGGER_ATTR = 'data-anakot-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-anakot-context-menu-trigger="" />
  )
}
