import type { ModelOptionProvider, ModelPricing } from '@anakot/shared'
import { fuzzyRank, modelSearchText } from '@anakot/shared'
...
import type { LocalModelLoadProgress } from '@/types/anakot'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `anakot
