...
// Anakot session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-anakot',
            keywords: ['update', 'upgrade', 'anakot', 'version', 'system', 'restart'],
            label: cc.updateAnakot,
