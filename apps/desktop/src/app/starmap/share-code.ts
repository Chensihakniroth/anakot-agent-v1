...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/anakot'
...
const VERSION = 3
const PREFIX = 'HML' // "Anakot Memory Loadout" — namespaces our codes like WoW's leading bytes.
