...
vi.mock('@/anakot', () => ({
  saveAnakotConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Anakot browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  anakotConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useAnakotConfigRecord: () => ({ data: mocks.loadedConfig })
}))
