...
describe('PreviewPane console state', () => {
  ...
  it('continues comment numbering in one conversation and resets it when the conversation changes', async () => {
    ...
    const previousDesktop = window.anakotDesktop
    let captureCount = 0
    ...
    window.anakotDesktop = previousDesktop
  })
...
describe('PreviewPane guest external handoff', () => {
  ...
  // reaches the OS browser only through the audited `anakot:openExternal` IPC.
  ...
  async function renderWebview() {
    ...
    desktopWindow.anakotDesktop = { openExternal } as unknown as Window['anakotDesktop']
