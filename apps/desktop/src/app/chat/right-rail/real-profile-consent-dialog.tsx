...
import { saveAnakotConfigRecord } from '@/anakot'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config } = useAnakotConfigRecord()
  const setConfig = anakotConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveAnakotConfigRecord({ browser: { use_real_profile: true } })
