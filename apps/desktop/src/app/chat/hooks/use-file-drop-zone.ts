...
import { type DroppedFile, extractDroppedFiles, ANAKOT_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ANAKOT_PATHS_MIME) ? 'files' : null
