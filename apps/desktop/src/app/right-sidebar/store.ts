...
const TAKEOVER_KEY = 'anakot.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Anakot can't clear via the API — the user
 *  sees exactly what runs instead of Anakot silently deleting their creds. */
