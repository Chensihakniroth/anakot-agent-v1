import type { AnakotReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AnakotReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AnakotReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
