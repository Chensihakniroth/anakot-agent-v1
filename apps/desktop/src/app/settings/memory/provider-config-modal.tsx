...
import { saveMemoryProviderConfig } from '@/anakot'
...
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/anakot'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.anakotDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
