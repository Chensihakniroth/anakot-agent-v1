...
const desktopWindow = window as unknown as { anakotDesktop: unknown }
const originalBridge = desktopWindow.anakotDesktop
...
afterEach(() => {
  ...
  desktopWindow.anakotDesktop = originalBridge
})
