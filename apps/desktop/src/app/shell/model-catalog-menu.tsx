import type { ModelOptionProvider, ModelOptionsResult } from '@anakot/shared'
import { DEFAULT_REASONING_EFFORT } from '@anakot/shared'
 ...
 * Returning `{}` is fine — the row then shows Anakot' defaults.
 */
