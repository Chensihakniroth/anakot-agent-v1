...
export interface TitlebarChromeContext {
  ...
  windowButtonPosition?: AnakotConnection['windowButtonPosition']
}
...
export function titlebarControlsPosition(
  windowButtonPosition: AnakotConnection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
...
export const TITLEBAR_CHROME_CHANGED_EVENT = 'anakot:titlebar-chrome-changed'
