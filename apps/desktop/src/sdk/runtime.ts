 ...
 * plugins resolve `@anakot/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __ANAKOT_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__ANAKOT_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __ANAKOT_PLUGIN_SDK__: sdk,
    __ANAKOT_REACT__: React,
    __ANAKOT_REACT_JSX__: jsxRuntime,
    __ANAKOT_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@anakot/plugin-sdk': shimUrl('__ANAKOT_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ANAKOT_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ANAKOT_REACT_JSX__'),
    react: shimUrl('__ANAKOT_REACT__')
  }
