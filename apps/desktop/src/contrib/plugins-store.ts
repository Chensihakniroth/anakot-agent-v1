 ...
 * `<anakot home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'anakot.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'anakot.desktop.disabledPlugins.v1'
