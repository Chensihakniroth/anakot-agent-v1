...
import { THEME_PRESET_PALETTES } from '@anakot/shared'
...
/**
 * Nous — the canonical Anakot desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Anakot's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Anakot desktop identity: GitHub's chrome carrying Nous
