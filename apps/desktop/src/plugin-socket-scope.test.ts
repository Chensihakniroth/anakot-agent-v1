...
// (#73044). Exercises the REAL anakot + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/anakot')
...
const conn = (over: Partial<AnakotConnection> = {}): AnakotConnection =>
  ({
    authMode: 'oauth',
