...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('anakot.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('anakot.desktop.unreadFinishedSessions')
