...
const POPOUT_STORAGE_KEY = 'anakot.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'anakot.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'anakot.desktop.composerPopout.zones.v1'
const LEGACY_ENABLED_KEY = 'anakot.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'anakot.desktop.composerPopout.position'
