...
describe('migrateTilesForProfile', () => {
  ...
  it('moves tabs, bot tiles, cached tails, remembered ids and owner hints to the new profile name', async () => {
    ...
    storage.writeJson('anakot.desktop.sessionTiles.v2', {
      webdesign_bhp: [
    ...
    storage.writeJson('anakot.desktop.sessionOwnerHints.v1', [
    ...
    const tiles = storage.readJson<Record<string, Tile[]>>('anakot.desktop.sessionTiles.v2')
