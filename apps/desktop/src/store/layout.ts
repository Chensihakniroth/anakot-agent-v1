...
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'anakot.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'anakot.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'anakot.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'anakot.desktop.sessionOrder.manual'
const SIDEBAR_GROUPING_STORAGE_KEY = 'anakot.desktop.sidebarGrouping'
const SIDEBAR_ALL_PROFILES_GROUPING_STORAGE_KEY = 'anakot.desktop.sidebarGrouping.allProfiles'
const SIDEBAR_ALL_PROFILES_AGENTS_GROUPED_STORAGE_KEY = 'anakot.desktop.sidebarAgentsGrouped.allProfiles'
const SIDEBAR_SORT_KEY_STORAGE_KEY = 'anakot.desktop.sidebarSortKey'
const SIDEBAR_ROW_META_STORAGE_KEY = 'anakot.desktop.sidebarRowMeta'
const SIDEBAR_CARD_ROWS_STORAGE_KEY = 'anakot.desktop.sidebarCardRows'
const SIDEBAR_SHOW_ALL_SESSIONS_STORAGE_KEY = 'anakot.desktop.sidebarShowAllSessions'
const SIDEBAR_STATUS_FILTER_STORAGE_KEY = 'anakot.desktop.sidebarStatusFilter'
const SIDEBAR_SHOW_ARCHIVED_STORAGE_KEY = 'anakot.desktop.sidebarShowArchived'
const SIDEBAR_PROJECT_FILTER_STORAGE_KEY = 'anakot.desktop.sidebarProjectFilter'
const SIDEBAR_PROFILE_FILTER_STORAGE_KEY = 'anakot.desktop.sidebarProfileFilter'
const SIDEBAR_PR_FILTER_STORAGE_KEY = 'anakot.desktop.sidebarPrFilter'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'anakot.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'anakot.desktop.workspaceParentOrder'
const SIDEBAR_PROJECT_ORDER_STORAGE_KEY = 'anakot.desktop.projectOrder'
const SIDEBAR_WORKSPACE_COLLAPSED_STORAGE_KEY = 'anakot.desktop.workspaceCollapsed'
...
const RIGHT_RAIL_ACTIVE_TAB_STORAGE_KEY = 'anakot.desktop.rightRailActiveTab'
...
export const $removedWorktreeIds = persistentAtom('anakot.desktop.removedWorktrees', [] as string[], Codecs.stringArray)
