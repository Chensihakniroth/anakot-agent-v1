...
import { getAnakotConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/anakot'
...
const SNOOZE_KEY_PREFIX = 'anakot:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getAnakotConfigRecord()
  } catch {
