...
function installBridge(
  openSessionWindow?: Window['anakotDesktop']['openSessionWindow'],
  openWindow?: Window['anakotDesktop']['openWindow'],
  openBrowserWindow?: Window['anakotDesktop']['openBrowserWindow']
) {
