...
export interface ComposerAttachment {
  ...
  thumbnailUrl?: string
  path?: string
  /** Bounded source text from a Anakot-generated large paste, sent only to the title path. */
  titlePreview?: string
...
export const SESSION_DRAFTS_STORAGE_KEY = 'anakot:composer-drafts:v3'
 ...
 */
const DRAFT_SYNC_EVENT = 'anakot:composer-draft-sync'
