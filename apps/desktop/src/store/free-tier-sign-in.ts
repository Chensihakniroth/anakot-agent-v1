...
import { cancelOAuthSession, listOAuthProviders, pollOAuthSession, startOAuthLogin } from '@/anakot'
...
// unreachable or refused mid sign-in (`anakot_cli/anon_sign_in.py`). Anything
...
/**
 * Drive one sign-in attempt end to end: resolve what identity this Anakot is
