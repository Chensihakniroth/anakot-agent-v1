import { addMcpServer, getMcpCatalog, listMcpServers, removeMcpServer } from '@/anakot'
...
import type { McpCatalogEntry } from '@/types/anakot'
 ...
 * `anakot mcp catalog`), by whole-word keyword and pasted-link host suffix,
