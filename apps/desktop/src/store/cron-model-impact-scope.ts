...
function identityForConnection(connection: AnakotConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: AnakotConnection | null): void {
