...
// v1 (`anakot.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'anakot.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'anakot.desktop.statusbarHidden'
// v1 (`anakot.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'anakot.desktop.statusbarVisible.v2'
