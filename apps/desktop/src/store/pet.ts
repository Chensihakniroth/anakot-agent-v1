...
export interface PetInfo {
  ...
  // the Anakot "run" activity state uses the in-place running row).
 ...
 * ANAKOT_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'anakot.desktop.pet-roam.v1'
