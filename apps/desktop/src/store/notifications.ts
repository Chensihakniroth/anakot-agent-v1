...
export const RECOVERY_ACTIONS = {
  restartAnakot: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartAnakot'),
 ...
 *  (`anakot_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartAnakot()
  },
  {
