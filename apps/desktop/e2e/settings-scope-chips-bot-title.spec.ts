...
function seedProfile(anakotHome: string, mockUrl: string, name: string, profileYaml: string): void {
...
test.beforeAll(async () => {
  ...
  // A Bot Mode bot: the roster shows ui_meta['anakot-bots'].title.
  seedProfile(sandbox.anakotHome, mock.url, 'alpha', 'ui_meta:\n  anakot-bots:\n    title: Atlas Prime\n')
  // A renamed profile: `anakot profile rename` writes display_name.
  seedProfile(sandbox.anakotHome, mock.url, 'beta', 'display_name: Beacon\n')
