...
test.beforeAll(async () => {
  ...
  seedWriterProfile(fixture.sandbox.anakotHome)
...
test('a DM addressed by the friendly name lands in that bot\'s Bot Chat', async () => {
  ...
  const home = fixture!.sandbox.anakotHome
  ...
  // The recipient turn is a full `anakot -p writer` CLI boot in the background; its
