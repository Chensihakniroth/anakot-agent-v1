...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @anakot/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@anakot/shared'],
              message: 'Plugins import only @anakot/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
