/**
 * Canonical Anakot skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ANAKOT_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`anakot_cli/skin_engine.py`),
 ...
 *   • CLI     → `anakot_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
