...
thinking phase.  Anakot's default cloud-stream stale detector
(``ANAKOT_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ANAKOT_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
