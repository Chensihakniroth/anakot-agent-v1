...
manipulation. Anakot keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ANAKOT_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_anakot_home /
    get_default_anakot_root) instead of monkeypatching private helpers —
    ...
    ANAKOT_HOME=<root>/profiles/<name> makes get_default_anakot_root()
