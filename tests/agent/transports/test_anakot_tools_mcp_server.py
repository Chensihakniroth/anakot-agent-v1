"""Tests for the anakot-tools-as-MCP server module surface.
...
from agent.transports.anakot_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import anakot_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.anakot_tools_mcp_server as m
