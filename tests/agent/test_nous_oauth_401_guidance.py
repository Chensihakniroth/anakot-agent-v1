...
to a generic "Your API key was rejected... run anakot setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "anakot setup".
    assert "anakot portal" in source
