...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("anakot.gateway.up"), _M("anakot.gateway.active_agents"),
        _M("anakot.gateway.busy"), _M("anakot.gateway.drainable"),
        _M("anakot.gateway.restart_requested"),
        _M("anakot.platform.up"), _M("anakot.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("anakot.cron.scheduler.heartbeat_age_seconds"),
        _M("anakot.cron.scheduler.last_success_age_seconds"),
        _M("anakot.cron.scheduler.catch_up_occurrences"),
        _M("anakot.cron.jobs.enabled"), _M("anakot.cron.jobs.running"),
        _M("anakot.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "Anakot Agent-owned Relay transport health" in text
