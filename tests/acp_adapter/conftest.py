...
Keeps the ACP server tests offline: ``AnakotACPAgent._build_model_state``
calls ``anakot_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import anakot_cli.inventory as inventory
