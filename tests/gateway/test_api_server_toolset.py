"""Tests for anakot-api-server toolset and API server tool availability."""
...
class TestAnakotApiServerToolset:
    """Tests for the anakot-api-server toolset definition."""


    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("anakot-api-server")
...
class TestApiServerPlatformConfig:
    ...
    def test_default_api_server_includes_terminal_toolset(self):
        ...
        anakot-api-server composite, so the old all-tools subset test dropped
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to anakot-api-server default
