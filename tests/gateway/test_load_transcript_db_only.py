...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.anakot/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at anakot_state import time, before pytest's ANAKOT_HOME monkeypatch
    fires — the autouse fixture's ANAKOT_HOME override doesn't help here.)
    """
    import anakot_state
