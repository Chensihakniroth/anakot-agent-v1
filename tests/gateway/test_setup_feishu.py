"""Tests for _setup_feishu() in anakot_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("anakot_cli.config.save_env_value", side_effect=mock_save), \
         patch("anakot_cli.config.get_env_value", side_effect=mock_get), \
         patch("anakot_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("anakot_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("anakot_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("anakot_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("anakot_cli.cli_output.print_header"), \
         patch("anakot_cli.cli_output.print_info"), \
         patch("anakot_cli.cli_output.print_success"), \
         patch("anakot_cli.cli_output.print_warning"), \
         patch("anakot_cli.cli_output.print_error"), \
