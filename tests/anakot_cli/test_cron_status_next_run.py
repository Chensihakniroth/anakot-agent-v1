...
from anakot_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_anakot_now", lambda: now)
    monkeypatch.setattr("anakot_time.now", lambda: now)
