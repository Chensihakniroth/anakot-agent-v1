"""Tests for `_can_open_graphical_browser()` in anakot_cli.auth.

Guards the fix for the May 2026 report where `anakot auth add xai-oauth`
...
from anakot_cli.auth import _can_open_graphical_browser
