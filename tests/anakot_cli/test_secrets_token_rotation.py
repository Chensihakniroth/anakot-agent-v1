"""Tests for `anakot secrets bitwarden token` / `anakot secrets onepassword token`.
...
from anakot_cli import onepassword_secrets_cli as op_cli
from anakot_cli import secrets_cli as bw_cli
