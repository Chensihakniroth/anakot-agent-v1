"""Regression test: anakot update must not load cryptography eagerly."""
...
assert 'anakot_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running anakot update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so anakot_cli is importable,
