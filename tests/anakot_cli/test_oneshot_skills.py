...
The oneshot path builds its AIAgent directly (bypassing AnakotCLI), so the
...
from anakot_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
