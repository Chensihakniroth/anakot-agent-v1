"""Tests for the shared tar.gz writer (``anakot_cli.archive_safe.make_targz``).

``make_targz`` backs both ``anakot profile export`` and ``anakot kanban
...
from anakot_cli.archive_safe import make_targz
