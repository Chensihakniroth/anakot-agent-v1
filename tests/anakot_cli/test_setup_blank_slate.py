"""Tests for Blank Slate setup mode (anakot_cli/setup.py).
...
from anakot_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
