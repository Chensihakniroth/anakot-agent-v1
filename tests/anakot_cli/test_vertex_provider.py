...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (anakot_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_anakot_overlays():
    """anakot_cli.providers.get_provider("vertex") backs
