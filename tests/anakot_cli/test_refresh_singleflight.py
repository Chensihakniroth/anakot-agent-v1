...
from anakot_cli.dashboard_auth import refresh_singleflight as replay
from anakot_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from anakot_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"anakot_session_at": "expired-at", "anakot_session_rt": "stale-rt",
               "anakot_session_provider": "stub"}
