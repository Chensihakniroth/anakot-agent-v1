...
def test_creator_origin_survives_without_dependency_parent(tmp_path, monkeypatch, capsys, surface):
    ...
    from anakot_cli.kanban_db_graph import decompose_triage_task
    ...
    with kbc.connect_closing() as conn:
        ...
        if surface == "builtin":
            ...
            import json
            import argparse
            from anakot_cli.kanban import kanban_command
            from anakot_cli.kanban_parser import build_parser
