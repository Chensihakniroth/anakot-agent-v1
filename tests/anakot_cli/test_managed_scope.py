"""Unit tests for anakot_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub ANAKOT_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "ANAKOT_MANAGED_DIR" not in os.environ
