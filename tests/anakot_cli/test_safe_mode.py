"""Tests for `anakot chat --safe-mode` isolation."""
...
_VARS = ("ANAKOT_SAFE_MODE", "ANAKOT_IGNORE_USER_CONFIG", "ANAKOT_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ANAKOT_SAFE_MODE"] == "1"
        assert os.environ["ANAKOT_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ANAKOT_IGNORE_RULES"] == "1"
        return True
