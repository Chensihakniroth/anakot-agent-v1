...
from anakot_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/anakot_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("anakot_cli.lifecycle.invoke_hook")
@patch("anakot_cli.lifecycle.finalize_session")
