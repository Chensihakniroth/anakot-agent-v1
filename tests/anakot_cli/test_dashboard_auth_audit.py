...
Profile-aware location: ``$ANAKOT_HOME/logs/dashboard-auth.log``.
...
from anakot_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ANAKOT_HOME and ~ to a tmp dir for the duration of the test."""
