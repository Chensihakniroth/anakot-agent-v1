"""Tests for ``anakot approvals suggest`` (anakot_cli/approvals_suggest.py).

Approval history in Anakot is implied, not ledgered: the session DB
...
from anakot_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
