"""Fetch-failure classification for `anakot update` / `anakot update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/Chensihakniroth/anakot-agent-v1.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `anakot update` sit on
    ...
    from anakot_cli import update_cmd_git
