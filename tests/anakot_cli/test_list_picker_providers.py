...
import anakot_cli.model_switch_providers as anakot_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(anakot_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("anakot_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import anakot_cli.models as hm
    import anakot_cli.models_catalog_static as anakot_cli_models_catalog_static
    from anakot_cli import models_catalog_static
    ...
    monkeypatch.setattr(anakot_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
