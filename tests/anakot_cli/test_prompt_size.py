"""Tests for the ``anakot prompt-size`` diagnostic (issue #34667)."""
...
from anakot_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(anakot_home, memory_text="", user_text=""):
    mem_dir = anakot_home / "memories"
...
def _seed_skill(anakot_home, name, description):
    skill_dir = anakot_home / "skills" / "demo" / name
