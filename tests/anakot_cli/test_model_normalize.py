"""Tests for anakot_cli.model_normalize — provider-aware model name normalization.
...
class TestColonProviderPrefixIsStrippedLikeSlash:
    """Issue #64787: ``-m openai-codex:gpt-5.6-sol`` (Anakot's own ``provider:model`` switch syntax)
