...
from anakot_cli.local_runtime.catalog import (
    CATALOG,
    catalog_by_id,
...
def test_catalog_and_preset_agree_on_identical_model_facts(tmp_path, monkeypatch):
    ...
    from anakot_cli.local_runtime import bootstrap, catalog, presets
    from anakot_cli.local_runtime.context_policy import RUNTIME_OVERHEAD_BYTES, ub_logits_bytes
    from anakot_cli.local_runtime.estimator import ctx_bytes
    from anakot_cli.web_routers.local_models import _catalog_row

    monkeypatch.setenv("ANAKOT_HOME", str(tmp_path))
    monkeypatch.setattr("anakot_cli.web_routers.local_models._engine_too_old", lambda tag: False)
...
def test_hybrid_long_context_stays_cheap():
    ...
    from anakot_cli.local_runtime.catalog import FLOOR
    from anakot_cli.local_runtime.estimator import ctx_bytes
