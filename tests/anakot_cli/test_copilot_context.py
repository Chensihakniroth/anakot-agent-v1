...
class TestGetCopilotModelContext:
    ...
    @patch("anakot_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("anakot_cli.models._urlopen_model_catalog_request")
    ...
    @patch("anakot_cli.models.fetch_github_model_catalog", return_value=[])
