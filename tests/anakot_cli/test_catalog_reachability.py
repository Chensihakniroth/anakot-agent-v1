...
Run before any catalog commit:
    ...
    ANAKOT_TEST_NETWORK=1 scripts/run_tests.sh tests/anakot_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ANAKOT_TEST_NETWORK"),
    reason="network test; set ANAKOT_TEST_NETWORK=1 to run",
)
