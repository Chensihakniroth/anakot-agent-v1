"""Regression: ``anakot update`` should take a managed checkout off autocrlf=true.
...
``anakot update`` has to repair them.
...
from anakot_cli.update_cmd import _normalize_managed_eol
