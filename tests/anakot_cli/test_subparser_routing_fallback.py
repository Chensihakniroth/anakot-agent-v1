...
The main() function in anakot_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `anakot -c model`
...
def _build_parser():
    """Build a minimal replica of the anakot top-level parser."""
