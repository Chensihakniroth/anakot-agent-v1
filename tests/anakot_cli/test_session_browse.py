"""Tests for the interactive session browser (`anakot sessions browse`).
...
from anakot_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """anakot sessions browse should be parseable."""
