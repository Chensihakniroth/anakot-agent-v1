"""Tests for the shared byte formatter (anakot_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from anakot_cli.backup import _format_size as backup
    from anakot_cli.checkpoints import _fmt_bytes as checkpoints
    from anakot_cli.sizefmt import format_bytes as doctor
