"""Regression: ``anakot doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Anakot *choosing* WAL mode (declined on vulnerable SQLite
