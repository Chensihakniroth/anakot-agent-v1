...
Covers the pure helpers in ``anakot_cli.partial_compress`` plus alias
...
from anakot_cli.commands import COMMANDS, resolve_command
from anakot_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
