...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and anakot-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # anakot-agent (tests/skills/)
]
