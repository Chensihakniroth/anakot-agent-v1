"""The `anakot-agent` skill is what a running Anakot knows about itself.

`website/` is never packaged, so an installed Anakot has no local copy of the
user guide; skills ARE synced into `$ANAKOT_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Anakot can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "anakot-agent"
