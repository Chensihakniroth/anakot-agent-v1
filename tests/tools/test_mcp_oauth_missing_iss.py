...
from tools.mcp_oauth_provider import AnakotProviderMixin  # noqa: E402


class _Provider(AnakotProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._anakot_oauth_flow = "browser"
    return provider
