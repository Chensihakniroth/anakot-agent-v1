...
* ``anakot_constants.get_anakot_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_anakot_dir so cache writes land under tmp_path."""
    ...
    with patch("anakot_constants.get_anakot_dir", _fake_get):
        yield cache_dir
