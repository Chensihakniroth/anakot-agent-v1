...
hardcoded "~/.anakot/scripts/" in its messages even though resolution goes
through get_anakot_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_anakot_home() is not the global ~/.anakot.
        scripts_dir = get_anakot_home() / "scripts"
