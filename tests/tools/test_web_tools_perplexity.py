...
def _assert_anakot_identity_headers(headers):
    """Both Perplexity endpoints carry the Anakot identity headers (same set as Kimi/OpenCode)
...
def test_search_dispatch_maps_search_api_shape():
    ...
    _assert_anakot_identity_headers(post.call_args.kwargs["headers"])
