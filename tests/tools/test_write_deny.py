...
class TestWriteDenyExactPaths:
    ...
    def test_anakot_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.anakot/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: ANAKOT_HOME does point to the profile dir, not the root.
        from anakot_constants import get_anakot_home, get_default_anakot_root
...
class TestWriteAllowed:
    ...
    def test_anakot_control_files_requested_writable(self):
