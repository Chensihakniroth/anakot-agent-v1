"""Session <-> workspace grouping key (anakot_state_sessions.workspace_key).

The key is what `anakot sessions list --workspace` groups/filters on. It is a
...
import anakot_state_sessions
from anakot_state_sessions import workspace_key
