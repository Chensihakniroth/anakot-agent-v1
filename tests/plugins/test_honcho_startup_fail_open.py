...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "anakot honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "anakot honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "anakot honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "anakot honcho peer --user"),
])
