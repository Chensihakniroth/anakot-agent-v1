...
from anakot_cli.auth import CODEX_RATE_LIMITED_CODE, AuthError
...
def _tick(job, home, deliveries, resolve):
    ...
    with patch("cron.scheduler._anakot_home", home), \
         ...
         patch("anakot_cli.runtime_provider.resolve_runtime_provider", side_effect=resolve), \
