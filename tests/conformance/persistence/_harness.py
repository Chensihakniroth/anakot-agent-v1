...
def make_anakot_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ANAKOT_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"anakot-home-{journal_mode}"
