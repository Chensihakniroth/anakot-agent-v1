...
The unit tests in tests/anakot_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned anakot-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/anakot")
from anakot_cli.service_manager import S6ServiceManager
