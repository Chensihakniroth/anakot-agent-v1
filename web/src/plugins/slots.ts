 ...
 * `window.__ANAKOT_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Anakot brand in the top bar
 ...
 *  `window.__ANAKOT_PLUGINS__.registerSlot(...)`.
 *
