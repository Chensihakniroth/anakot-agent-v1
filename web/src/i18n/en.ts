...
export const en: Translations = {
  ...
  status: {
    ...
    updateAnakotConfirmMessage:
      "This runs anakot update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateAnakotConfirmNow: "Update now",
    updateAnakotConfirmTitle: "Update Anakot?",
    updatingAnakot: "Updating Anakot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Anakot plugins (`anakot plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.anakot/plugins/?",
    removeHint: "Only user-installed plugins under ~/.anakot/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Anakot plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `anakot skills search <topic>`.",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Anakot doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Anakot Achievements",
      subtitle:
        "Collectible Anakot badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Anakot session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Anakot more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Anakot sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Anakot is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Anakot Agent ☤",
    },
  },
