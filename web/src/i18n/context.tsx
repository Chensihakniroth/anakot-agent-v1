import { applyDocumentLocale, LOCALE_ENDONYMS } from "@anakot/shared/i18n";
...
// Display metadata for the language picker — endonyms from @anakot/shared so the
...
const STORAGE_KEY = "anakot-locale";
