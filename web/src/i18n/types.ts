...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateAnakot: string;
    updateAnakotConfirmMessage?: string;
    updateAnakotConfirmNow?: string;
    updateAnakotConfirmTitle?: string;
    updatingAnakot: string;
  ...
  // ── Achievements plugin (plugins/anakot-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
