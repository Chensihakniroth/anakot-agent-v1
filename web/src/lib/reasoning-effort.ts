 ...
 *
 * Values come from @anakot/shared (anakot_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Anakot
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Anakot' default when unset). */
