...
const STORAGE_KEY = "anakot-dashboard-theme";
...
const FONT_STORAGE_KEY = "anakot-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `anakot_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "anakot-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-anakot-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-anakot-theme-font", "true");
