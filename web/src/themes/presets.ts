import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@anakot/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `anakot_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@anakot/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Anakot Teal",
  description: "Classic dark teal — the canonical Anakot look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Anakot Teal (Large)",
  description: "Anakot Teal with bigger fonts and roomier spacing",
