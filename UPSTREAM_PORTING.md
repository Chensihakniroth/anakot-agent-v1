...
| 836b5f82 | 2026-09-22 | fix(config): user-installed platform plugins feed env-var metadata | PENDING | |
...
| d6758299 | 2026-09-22 | test(kanban): fold workspace-survival check into gc bounds parametrize | PENDING | |
| 1c189141 | 2026-09-22 | refactor(kanban): narrow _nonnegative_int except to ValueError | PENDING | |
| e8ae808b | 2026-09-22 | refactor(kanban): share _retention_seconds helper across gc sweeps | PENDING | |
| 1be926db | 2026-09-22 | refactor(kanban): drop redundant int() in gc_events cutoff | PENDING | |
| 9134d322 | 2026-09-22 | test(kanban): fix slash gc docstring | PENDING | |
| 4937999d | 2026-09-22 | docs(kanban): state gc retention semantics | PENDING | |
| ca879980 | 2026-09-22 | refactor(kanban): share negative-retention ValueError message | PENDING | |
| e760226c | 2026-09-22 | test: collapse duplicated kanban gc retention tests | PENDING | |
| bf8b2d80 | 2026-09-22 | fix(kanban): reject negative retention at argparse boundary | PENDING | |
| 4baff6fb | 2026-09-22 | kanban gc: validate retention flags before workspace sweep | PENDING | |
| b01b1c8b | 2026-09-22 | fix(kanban): bound gc retention days so -N/0 cannot mass-delete | PENDING | |
| 78dfd6e6 | 2026-09-22 | docs(skills): explain undecodable ledger warning | PENDING | |
| d3684a7d | 2026-09-22 | test(skills): assert missing-ledger case emits no warning | PENDING | |
| 14b29a42 | 2026-09-22 | refactor(skills): abort blob GC from single malformed-row guard | PENDING | |
| 5194561c | 2026-09-22 | refactor(skills): share _read_ledger() helper | PENDING | |
| dd309d04 | 2026-09-22 | fix(skills): warn when list_entries() hits corrupt ledger | PENDING | |
| 69002c92 | 2026-09-22 | docs(skills): document unreadable ledger aborting blob GC | PENDING | |
| 14240116 | 2026-09-22 | test(skills): make unreadable-ledger fixture transport-agnostic | PENDING | |
| 83cf0ef8 | 2026-09-22 | fix(skills): treat undecodable ledger as empty in list_entries() | PENDING | |
| 0c5beaad | 2026-09-22 | test(skills): pin compact_ledger() no-op on undecodable ledger | PENDING | |
| 2a9c27f1 | 2026-09-22 | fix(skills): warn when compaction skipped (unreadable ledger) | PENDING | |
| 1d6c1c2f | 2026-09-22 | fix(skills): abort blob GC on non-dict ledger row | PENDING | |
| 49aa7215 | 2026-09-22 | fix(skills): warn when blob GC skipped over malformed line | PENDING | |
| 1cb30951 | 2026-09-22 | test: drop incidental encoding= edits from unrelated ledger test | PENDING | |
| 25f1f6fc | 2026-09-22 | fix(skills): guard compact_ledger() against undecodable bytes | PENDING | |
| b9183820 | 2026-09-22 | fix(skills): warn when blob GC skipped (unreadable ledger) | PENDING | |
| 9e1a92c8 | 2026-09-22 | fix(skills): preserve rollback blobs when ledger reads fail | PENDING | |
| b34cd9b2 | 2026-09-22 | test(stt): drop dead shutil.which patch in CAF neighbor test | PENDING | |
| 43833ed9 | 2026-09-22 | fix(stt): tolerate CAF work-dir cleanup errors | PENDING | |
| 2b2fd4b9 | 2026-09-22 | test: fold CAF isolation test into TestCafConversion | PENDING | |
| c17dafee | 2026-09-22 | fix(stt): isolate CAF conversions from source recordings | PENDING | |
