...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Anakot session"),
        ...
        _cmd("status", "Show Anakot session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running anakot agent"),
        ...
        _cmd("update", "Update Anakot Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Anakot gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Anakot session in it",
