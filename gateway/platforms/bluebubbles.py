...
# `require_mention: true` without custom aliases uses Anakot wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?anakot\s+agent\b[,:\-]?", r"(?<![\w@])@?anakot\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Anakot defaults)."""
