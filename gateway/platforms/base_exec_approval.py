...
the same three things: what Anakot wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Anakot wants to run a command that needs your OK"
