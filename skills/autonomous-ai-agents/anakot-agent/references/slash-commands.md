...
Registry of record: `anakot_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Anakot config+state snapshots (CLI)
...
/update                  Update Anakot to latest
