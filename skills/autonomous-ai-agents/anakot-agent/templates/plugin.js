/**
 * Anakot desktop plugin template. Save as:
 *   <anakot home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <anakot home> is ~/.anakot by default, or ~/.anakot/profiles/<name>
 * when running a named profile (`anakot -p <name>`). Run `anakot doctor` (or
 ...
 * Only these imports resolve: @anakot/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@anakot/plugin-sdk'
