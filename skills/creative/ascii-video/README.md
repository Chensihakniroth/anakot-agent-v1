...
Built for [Anakot Agent](https://github.com/Chensihakniroth/anakot-agent-v1). Usable in any coding agent. Canonical source lives here; synced to [`Chensihakniroth/anakot-agent-v1/skills/creative/ascii-video`](https://github.com/Chensihakniroth/anakot-agent-v1/tree/main/skills/creative/ascii-video) via PR.
