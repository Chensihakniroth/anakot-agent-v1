...
def interactive_setup() -> None:
    ...
    from anakot_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where Anakot delivers cron job results and notifications.",
