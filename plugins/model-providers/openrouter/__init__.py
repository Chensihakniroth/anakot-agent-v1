...
class OpenRouterProfile(ProviderProfile):
    ...
    def _clamp_reasoning_to_catalog(cfg: dict[str, Any], model: str | None) -> dict[str, Any] | None:
        ...
        if not effort and not disabled:
            return cfg
        try:
            from anakot_cli.models import clamp_reasoning_effort_to_supported
            from anakot_cli.models_reasoning_caps import openrouter_model_reasoning_capabilities
    ...
    def fetch_models(
        ...
        filtering happens in anakot_cli/models.py, which the picker reaches first."""
    ...
    def build_api_kwargs_extras(
        ...
        if supports_reasoning:
            ...
            # turn after the first tool call. See anakot-agent#42991 (disable case) and the tool-replay
            ...
            # anakot-agent#43432). Route the existing ``reasoning_config["effort"]`` (sourced from
